...
public class ManagerServiceImpl implements ManagerService {
    ...
    @Override
    public List <Manager> getAllManagers(String keyword) {
        if (keyword != null) {
            return managerRepository.search(keyword);
        }
...
//    }
    ...
    public Manager validateManager(Manager manager){
        ...
        Manager m = managerRepository.validateManager(manager.getEmail(),manager.getPassword());
        return m;
    }
}
